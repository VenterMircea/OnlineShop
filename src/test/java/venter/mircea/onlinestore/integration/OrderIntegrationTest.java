package venter.mircea.onlinestore.integration;
...
import venter.mircea.onlinestore.utils.mongodb.MongoDataFile;
import venter.mircea.onlinestore.utils.mongodb.MongoSpringExtension;
...
public class OrderIntegrationTest {
    ...
    void createOrderFailure() throws Exception {
        ...
        Map<String, Integer> orderedProducts = OrderTestUtils.testHMOrderedProduct("6034068975bb0d4088a441c2", 1);
        OrderDtoNoId orderToBeSavedNoId = OrderTestUtils.testOrderDtoNoId(1.1, "603648273ed85832b440eb99");
    ...
    void updateOrder() throws Exception {
        ...
        OrderDto orderToPut = OrderTestUtils.testOrderDto("6037a0ab9cfa0f22a397ac4c", 2.1, "userId1");
