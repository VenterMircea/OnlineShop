...
import venter.mircea.onlinestore.service.implementation.ProductServiceImpl;
...
import venter.mircea.onlinestore.utils.ProductTestUtils;
...
class ProductControllerTest {
    ...
    void testFindById() throws Exception {
        ...
        ProductDto productDto = ProductTestUtils.createProductDto(productId, "test1", "test", 0.0, 0.0,
                0, "test1", "test1");
    ...
    void testCreateProductWithMultipartFile() throws Exception {
        // GIVEN
        ProductDtoNoId requestProductDto = ProductTestUtils.createProductDto(null, "test1", "test", 0.0, 0.0,
                0, "", "test1");
        ...
        ProductDto createdProduct = ProductTestUtils.createProductDto("1", "test1", "test", 0.0, 0.0,
                0, "imageId", "test1");
    ...
    void testUpdateProduct() throws Exception {
        String productId = "1234";
        ProductDtoNoId product = ProductTestUtils.createProductDtoNoId("test1", "test1", 0.0, 0.0,
                0, "test1", "test1");
        ProductDto updateProduct = ProductTestUtils.createProductDto(productId, "test1update", "test1update", 2.5, 0.0,
