...
public class CartIntegrationTest {
    ...
    void createCart() throws Exception {
        ...
        CartDtoNoId cartToBeSavedNoId = CartTestUtils.createCartDtoNoId("testtest", cartProducts);
    ...
    void updateCart() throws Exception {
        ...
        String cartId = "1234567";
        CartDtoNoId cartDtoNoId = CartTestUtils.createCartDtoNoId("testtest22", cartProducts);
