...
import venter.mircea.onlinestore.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Page<ProductDto>> findAll(UserPageDto userPageDto) {
        return ResponseEntity.status(HttpStatus.OK).
                body(productService.findAll(userPageDto));
    }
    ...
    public ResponseEntity<List<InputStreamResource>>
    findProductImagesByProductId(@PathVariable String productId)
    {
        List<GridFsResource> gridFsResources = productService.
    ...
    updateProduct(@PathVariable String id, @Valid @RequestBody ProductDtoNoId productDtoNoId)
    {
        return ResponseEntity.status(HttpStatus.OK).
                body(productService.updateProduct(id, productDtoNoId));
    }
