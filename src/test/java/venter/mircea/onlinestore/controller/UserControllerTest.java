...
import venter.mircea.onlinestore.service.implementation.UserServiceImpl;
...
import venter.mircea.onlinestore.utils.UserTestUtils;
...
class UserControllerTest {
    ...
    void testFindAll() throws Exception {
        // GIVEN
        UserDto mockUser1 = UserTestUtils.createUserDto("1", "John", "Wayne", "johnwayne@movies.com",
                "johnwayne", "pistols", "123-456-789", "M", "Main Street 1",
                "Las Vegas", "Nevada", "123456");
        UserDto mockUser2 = UserTestUtils.createUserDto("2", "John", "Travolta", "johntravolta@movies.com",
    ...
    void testFindById() throws Exception {
        // GIVEN
        UserDto mockUser = UserTestUtils.createUserDto("1", "John", "Wayne", "johnwayne@movies.com",
                "johnwayne", "pistols", "123-456-789", "M", "Main Street 1",
                "Las Vegas", "Nevada", "123456");
    ...
    void testCreateUser() throws Exception {
        // GIVEN
        UserDtoNoId requestDto = UserTestUtils.createUserDto(null, "John", "Wayne", "johnwayne@movies.com",
                "johnwayne", "pistols", "123-456-789", "M", "Main Street 1",
                "Las Vegas", "Nevada", "123456");

        AddressEntity addressEntity = requestDto.getAddressEntity();
        UserDto createdUser = UserTestUtils.createUserDto("1", requestDto.getFirstName(), requestDto.getLastName(), requestDto.getEmail(),
    ...
    void testUpdateUser() throws Exception {
        ...
        UserDto updatedUserDto = UserTestUtils.createUserDto(userId, "John", "Wayne", "johnwayne@movies.com",
                "johnwayne", "pistols", "123-456-789", "M", "Main Street 1",
                "Las Vegas", "Nevada", newPostalCode);
