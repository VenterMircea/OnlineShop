...
import venter.mircea.onlinestore.exceptionhandler.EntityNotFoundException;
...
import venter.mircea.onlinestore.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    private List<ProductLine> createProductLinesHelperEntity(OrderDtoNoId orderDtoNoId) {
        ...
        for (Map.Entry<String, Integer> entry : orderDtoNoId.getOrderedProducts().entrySet()) {
