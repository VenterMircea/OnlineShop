...
import venter.mircea.onlinestore.service.implementation.OrderServiceImpl;
...
import venter.mircea.onlinestore.utils.OrderTestUtils;
...
public class OrderControllerTest {
    ...
    public void findById() throws Exception {
        ...
        OrderDto foundOrder = OrderTestUtils.testOrderDto("orderId", 12.1, "userID");
    ...
    public void findByUserId() throws Exception {
        ...
        List<OrderDto> orderByUserId = OrderTestUtils.testOrderDtoList();
    ...
    public void findAll() throws Exception {
        List<OrderDto> orders = OrderTestUtils.testOrderDtoList();
    ...
    public void createOrder() throws Exception {
        //GIVEN
        Map<String, Integer> orderedProducts = OrderTestUtils.testHMOrderedProduct("a", 1);
        OrderDtoNoId orderToBeSavedNoId = OrderTestUtils.testOrderDtoNoId(1.1, "orderUserId");

        orderToBeSavedNoId.setOrderedProducts(orderedProducts);
        OrderDto orderToBeSaved = OrderTestUtils.testOrderDto("orderId", 1.1, "orderUserId");
    ...
    public void updateOrder() throws Exception {
        String id = "orderId1";
        OrderDtoNoId order = OrderTestUtils.testOrderDtoNoId(1.1, "userId1");
        OrderDto orderToPut = OrderTestUtils.testOrderDto("orderId1", 2.1, "userId1");
